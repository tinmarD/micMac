...
if lowscreendepth    
    ...
    BACKCOLOR           = vi_graphics('backgroundcolor');    % EEGLAB Background figure color 
    BACKEEGLABCOLOR     = vi_graphics('backgroundcolor');    % EEGLAB main window background
%     BACKEEGLABCOLOR     = vi_graphics('background_color');    % EEGLAB main window background
    GUIBUTTONCOLOR      = [1,1,1];% Buttons colors in figures
    GUIPOPBUTTONCOLOR   = GUIBUTTONCOLOR;      % Buttons colors in GUI windows
    GUIBACKCOLOR        = vi_graphics('eeglabpopupbackcolor');% EEGLAB GUI background color <---------
    GUITEXTCOLOR        = vi_graphics('textcolor');      % GUI foreground color for text
    PLUGINMENUCOLOR     = [.5 0 .5];      % plugin menu color
end;
