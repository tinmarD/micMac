function [VI, ALLWIN, ALLSIG] = pop_exportdatabychannel (VI, ALLWIN, ALLSIG)
% [VI, ALLWIN, ALLSIG] = POP_EXPORTDATABYCHANNEL (VI, ALLWIN, ALLSIG)
% Popup window to export data to a matlab array. Each channel is saved in a
% different file.
